...
def print_epoch_summary(mgr_list, repeat_header_interval=8):
    # Define headers
    headers = ["epoch", "PAP - take out", "MAPE", "R^2", "Mean Absolute Error", " Total Absolute Error", "Mean Square Error", "Final Weight", "Final Bias"]
...
def print_logs(mgr_list):
    headers = ["Epoch", "Iteration", "Input", "Target", "Prediction", "Error", "Old Weight", "New Weight", "Old Bias", "New Bias","Model"]
