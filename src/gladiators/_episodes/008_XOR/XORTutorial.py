...
class NeuralNetwork(Gladiator):
    """Weights:[array([
        N1
        [-7.27385289, -6.71847057, -0.44606242],
        [-7.28116425, -6.78858705, -3.78245129],
        [ 7.9434255 ,  2.66380433, -1.93237779]])
    """
