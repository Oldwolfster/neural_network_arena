...
class Income__Experience_CompanyRevenue(BaseArena):
    ...
    def generate_training_data(self) -> List[Tuple[float, float, float]]:
        ...
        for _ in range(self.num_samples):
            ...
            company_revenue = random.uniform(           10, 1000)  # Large-scale feature
            base_salary = 30_000
            coeff_exp = 2000
            coeff_revenue = 1  # Tiny weight for the large-scale feature
            noise = random.gauss(0, 0)  # Add noise for realism
            salary = (base_salary +
                      coeff_exp * years_exp +
