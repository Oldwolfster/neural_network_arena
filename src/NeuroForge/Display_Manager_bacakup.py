...
class Display_Manager:
    ...
    def initialize_components(self):
        ...
        button_info = Button_Base(my_surface= Const.SCREEN, text="Info", width_pct=panel_width, height_pct=4, left_pct=1, top_pct=5, on_click=self.show_info, shadow_offset=-5)
        self.components.append(button_info)
        #self.eventors.append(button_info)
