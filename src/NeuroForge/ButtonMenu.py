...
class ButtonMenu:
    ...
    def __init__(self):
        ...
        self.height = 40
        self.top = 40
        self.left = Const.SCREEN_WIDTH - 30 - self.width  # Positioning on the right side
    ...
    def draw(self):
        ...
        pygame.draw.rect(Const.SCREEN, self.shadow_color, shadow_rect, border_radius=shadow_offset * 2)
        pygame.draw.rect(Const.SCREEN, self.main_button_color, self.button_rect, border_radius=shadow_offset * 2)
